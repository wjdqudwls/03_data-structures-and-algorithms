 ...
 *   배열을 반씩 나누어(1~2개의 요소가 남을 때 까지) 정렬한 후 병합하는 방식
...
public class E_MergeSort {
  ...
  private static void
    ...
    // <-> 분할된 배열의 크기가 1이하인 경우에느 수행 X
    //     --> if문 수행 종료 == 분할된 벼열이 정렬 완료됨
    if (left < right) {
